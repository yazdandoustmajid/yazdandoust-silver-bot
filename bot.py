...
async def _main_locked():
    ...
    try:
        ...
        if (
            ...
            # پیام صبح بخیر را تا 11:30 نگه می‌داریم تا اگر اجرای 08:00
            # یا یکی از اجراهای بعدی با تأخیر انجام شد، پیام جا نماند.
            # should_send_daily از ارسال تکراری در همان روز جلوگیری می‌کند.
            current_minute
            <
            11 * 60
            + 30
