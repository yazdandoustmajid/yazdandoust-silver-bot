...
async def send_sticker(
    ...
    try:
        ...
        # attached to the document. Simply uploading a .webp is not enough.
        # Without DocumentAttributeImageSize, clients don't know it's an
        # image-sized document and render it as a plain downloadable file
        # instead of an inline sticker.
        try:
