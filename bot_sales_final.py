    ...
    while (
        ...
        try:
            ...
            if not isinstance(products_probe, dict):
                ...
                # Taqizadegan's channel message itself is the primary live
                # trigger. If a new board/rate message appears, publish it
                # immediately even when the parsed product prices happen to
                # be unchanged. This prevents waiting for the 90-minute
                # scheduler or the next product-price delta.
                source_changed = product_changed or source_message_changed
